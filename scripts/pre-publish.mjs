...
if (hasErrors) {
  ...
  console.log('  pnpm --filter @likha/core publish --access public');
  console.log('  pnpm --filter @likha/ui publish --access public');
  console.log('  pnpm --filter @likha/plugins publish --access public');
  console.log('  pnpm --filter @likha/html publish --access public');
}
